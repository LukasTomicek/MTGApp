...
kotlin {
    androidLibrary {
        namespace = "mtg.app.feature.trade.di"
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            implementation(projects.composeApp.feature.trade.data)
            implementation(projects.composeApp.feature.trade.domain)
            implementation(projects.composeApp.feature.trade.infrastructure)
